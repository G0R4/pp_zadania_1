namespace pp_zadania_2
{
    internal class Zadania
    {
        ...
        {
            /*Zadanie_1 zadanie_1 = new Zadanie_1();
            zadanie_1.PrintLiczbyWOdwrotnejKolejnosci(); 
            ...
            zadanie_7.PrintSredniaArytmetycznaLiczbPodawanychAzDoStop(); 
            ...
            zadanie_12.PrintKolkoIKrzyzykTrzy(); 

            Zadanie_13 zadanie_13 = new Zadanie_13();
            zadanie_13.PrintZadanieTrzynaste(); 
